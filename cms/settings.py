...
SECRET_KEY = 'django-insecure-2pbn)!u-t=9#-shn2+#jo)*imd%ja-%*))b@)$=1mas3erxlp4'
...
MIDDLEWARE = [
    ...
    'clg.middleware.SessionTimeoutMiddleware',  # Your custom middleware
...
if not DEBUG:  # Only when DEBUG is False
